    ...
    <div className={`container ${style.container}`}>
      <div className={style.basket}>
        ...
        <div className={style.purchase}>
          ...
          <OrangeBtn active={disabled} clickBtn={() => setActive(true)}>Перейти к оплате</OrangeBtn>
            ...
            <div className={style.modal__container}>
              ...
              <div className={style.content}>
                ...
                {methodValue.map(elem => (
                  <div key={elem} className={methodPayment === elem? [style.method, style.active].join(' '): style.method} onClick={() => changeMethod(elem)}>{elem}</div>
                ))}
              </div>
              <p>К оплате: <span>{finaliPrice} {methodPayment}</span></p>
